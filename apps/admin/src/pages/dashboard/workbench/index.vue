...
<template>
  <div class="grid grid-cols-24 grid-rows-24 w-full h-screen">
    ...
    <!--        <div class="">-->
    <!--          <img alt="Todo icon" src="@/assets/images/Todo.png"/>-->
    <!--        </div>-->
    ...
    <!--      <div class="w-3/4 flex justify-around">-->
    <!--        <div>-->
    <!--          <img alt="Notification icon" src="@/assets/images/Notification.png"/>-->
    <!--        </div>-->
    ...
    <!--      <div class="w-3/4 flex justify-around">-->
    <!--        <div>-->
    <!--          <img alt="meeting Icon" src="@/assets/images/meeting.png"/>-->
    <!--        </div>-->
    <!--        <div-->
    ...
    <!--      </div>-->
    <!--    </div>-->
    <!--    &lt;!&ndash; Todo List End &ndash;&gt;-->

    <!--    &lt;!&ndash; chart start &ndash;&gt;-->
    <!--    <div-->
    ...
    <!--    </div>-->
    <!--    &lt;!&ndash; chart end &ndash;&gt;-->

    <!--    &lt;!&ndash; Latest News start &ndash;&gt;-->
    <!--    <div-->
    ...
    <!--      </div>-->
    <!--    </div>-->
    <!--    &lt;!&ndash; Latest News end &ndash;&gt;-->

    <!--    &lt;!&ndash; member charts start &ndash;&gt;-->
    <!--    <div-->
